...
public class Class2Table {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Connection conn = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/mytest?useUnicode=true&characterEncoding=utf-8", "root", "root");
        Statement st = conn.createStatement();
        System.out.println(File.separator);
        System.out.println("com.dyz.etlcomposer.model".replace(".", File.separator));
        URL resource = Thread.currentThread().getContextClassLoader().getResource("com/dyz/etlcomposer/model");
        ...
        for (File item : files) {
            ...
            Class<?> aClass = Class.forName("com.dyz.etlcomposer.model." + className);
